<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageAdmin.Master" AutoEventWireup="true" CodeBehind="DoanhThu.aspx.cs" Inherits="MinKi.Admin.DoanhThu" %>
...
&nbsp;&nbsp;
                         <asp:Label ID="Label2" runat="server" style="color:blue" Text="Tổng Doanh Thu:"></asp:Label>&nbsp;
    ...
    <div>
    <center>
<asp:GridView ID="gvDH" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" OnPageIndexChanging="GridView1_PageIndexChanging" Width="100%">
    <AlternatingRowStyle BackColor="White" />
    <Columns>
        <asp:BoundField DataField="MaDH" HeaderText="Mã" />
        <asp:BoundField DataField="TenTK" HeaderText="Người Duyệt" />
        ...
        <asp:BoundField DataField="TenNN" HeaderText="Tên Người Nhận" />
         <asp:BoundField DataField="DC" HeaderText="Địa Chỉ Giao Hàng" />
