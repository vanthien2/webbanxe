<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Home.Master" AutoEventWireup="true" CodeBehind="KetQuaTimKiem.aspx.cs" Inherits="MinKi.Client.KetQuaTimKiem" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:DataList ID="dlKQ" runat="server" DataKeyField="SoKhung" RepeatColumns="4" OnSelectedIndexChanged="dlKQ_SelectedIndexChanged">
       <ItemTemplate>
         ...
         <tr><td><asp:Image alt="No images" ID="Image1" runat="server" ImageUrl='<%# "~/Images/"+Eval("Anh") %>' /></td></tr>
            ...
            <br />
             <tr> <td><asp:Label ID="lbGia" runat="server" class="gia" Text='<%# "  "+Eval("DonGia","{0:0,000} VNĐ")%>'></asp:Label></td></tr>
                ...
                <tr>
                <td>
                    <asp:Button ID="btnthem" runat="server"  Text="Đặt Mua" CommandArgument='<%# Eval("SoKhung") %>' oncommand="btnthem_Command1" Width="137px" />
                </td>
            </tr>
            </table>
        </ItemTemplate>
